...
e=Entry(mansLogs,width=15,bg='white',bd=20,font=('Arial Black',20))
...
btn3=Button(mansLogs,text='3',fg='white',bg='dimgray',bd=20,font=('Arial Black',20),padx='40',pady='20',command=lambda:btnClick(3))
btn4=Button(mansLogs,text='4',fg='white',bg='dimgray',bd=20,font=('Arial Black',20),padx='40',pady='20',command=lambda:btnClick(4))
btn5=Button(mansLogs,text='5',fg='white',bg='dimgray',bd=20,font=('Arial Black',20),padx='40',pady='20',command=lambda:btnClick(5))
btn6=Button(mansLogs,text='6',fg='white',bg='dimgray',bd=20,font=('Arial Black',20),padx='40',pady='20',command=lambda:btnClick(6))
btn7=Button(mansLogs,text='7',fg='white',bg='dimgray',bd=20,font=('Arial Black',20),padx='40',pady='20',command=lambda:btnClick(7))
btn8=Button(mansLogs,text='8',fg='white',bg='dimgray',bd=20,font=('Arial Black',20),padx='40',pady='20',command=lambda:btnClick(8))
btn9=Button(mansLogs,text='9',fg='white',bg='dimgray',bd=20,font=('Arial Black',20),padx='40',pady='20',command=lambda:btnClick(9))
